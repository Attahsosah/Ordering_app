function Items() {
    return (
        <div className="items-center z-20 shadow-lg  bg-opacity-60  ">
            <h1 className="  pl-11 font-bold text-white items-center justify-center text-9xl py-10 Koulen" >The best food in town</h1>
        <div className="pl-24 bg-red-900 pb-0">
            <h1 className="text-white text-2xl font-bold">Our offers</h1>
        </div>
            <div className="flex  items-center pt-4 pl-7 overflow-x-scroll w-[1200px] ">

                <div className="hover:scale-110 hover:pr-5 items-center border-r-2 border-gray-900 h-96 w-full rounded-lg bg-bg1 transition transform duration-1000 ease-out bg-transparent hover:cursor-pointer">
